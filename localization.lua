...
OVERACHIEVER_STRINGS = {
	...
	OPT_LETITSNOWTIPS = "Add whether you need to use a Handful of Snowflakes on a player";
	...
	OPT_FISTFULOFLOVETIPS = "Add whether you need to use a Handful of Rose Petals on a player";
